...
public class CompanyCodeGeneratorTest {
	...
	public void testClaim() {
		...
		request.getOptions().setEntityPackage("org.lab.samples.osm.nwt.company.model");
		request.getOptions().setExecutorPackage("org.lab.samples.osm.nwt.company.executor");
